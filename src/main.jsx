  ...
  return <>
    <div className="login-shell">
      <section className="login-hero">
        ...
        <p>DeutschOS 覆盖申请者建档、项目匹配、顾问复核、风险监控与 DeepSeek 辅助文书，帮助把德国硕士申请从经验驱动升级为可核验、可追踪、可复用的协同流程。</p>
        <div className="flow-strip"><span>申请者建档</span><b>→</b><span>DeepSeek 建议</span><b>→</b><span>顾问复核</span><b>→</b><span>管理者质控</span></div>
      </section>
